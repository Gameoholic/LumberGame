 ...
 */
public class LumberMeleeAttackGoalOld extends Goal {
    ...
    public LumberMeleeAttackGoalOld(PathfinderMob mob, double speed, int attackCooldown) { // todo: remove speedmofidier it always 1.0
        this.mob = mob;
