...
public class TestMeleeGoal extends Goal {
    ...
    public TestMeleeGoal(PathfinderMob mob, double speed, boolean pauseWhenMobIdle) {
        this.mob = mob;
    ...
    protected void resetAttackCooldown() {
        this.ticksUntilNextAttack = this.adjustedTickDelay(20); // 20
    }
